...
--
-- Servidor: localhost
-- Tiempo de generación: 10-07-2014 a las 18:34:22
...
(19, 1, '2014-07-08 19:07:45', 'titulitoo', 'contenidooo', 'No enviada'),
(20, 1, '2014-07-08 19:07:07', 'titulo titulo', 'contenido contenido', 'No enviada');
...
,`PRA_EVAEMPRESA` float(2,1) unsigned
,`PRA_EVAPROFESOR` float(2,1) unsigned
);
-- --------------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `practica` (
  ...
  `PRA_EVAEMPRESA` float(2,1) unsigned DEFAULT NULL,
  `PRA_EVAPROFESOR` float(2,1) unsigned DEFAULT NULL,
  `PRA_DESCRIPCION` text NOT NULL,
  `PRA_INICIO` date NOT NULL,
  `PRA_TERMINO` date NOT NULL,
  `PRA_TIPO` enum('1','2') NOT NULL,
  `PRA_DIRF1` varchar(100) DEFAULT NULL,
  `PRA_DIRF3` varchar(100) DEFAULT NULL,
...
INSERT INTO `practica` (`PRA_ID`, `CAR_CODIGO`, `PER_ID`, `PRA_ESTPRACTICA`, `PRA_ESTF1`, `PRA_ESTF3`, `PRA_ESTINFORME`, `PRA_EVAEMPRESA`, `PRA_EVAPROFESOR`, `PRA_DESCRIPCION`, `PRA_INICIO`, `PRA_TERMINO`, `PRA_TIPO`, `PRA_DIRF1`, `PRA_DIRF3`) VALUES
(1, 1, 4, 'Pendiente', 1, 1, 1, 4.0, 3.0, 'holi', '0000-00-00', '2014-04-15', '1', NULL, NULL),
(2, 1, 6, 'Aprobado', 1, 1, 1, 4.0, 6.0, 'prueba', '0000-00-00', '2014-04-16', '2', NULL, NULL),
(3, 1, 4, 'Pendiente', 0, 0, 0, NULL, NULL, 'practica de usuario', '2014-06-20', '0000-00-00', '1', NULL, NULL),
(12, 1, 34, 'Pendiente', 0, 0, 0, NULL, NULL, 'practica 1', '2014-06-20', '0000-00-00', '1', NULL, NULL),
(13, 1, 4, 'Pendiente', 0, 0, 0, NULL, NULL, 'nueva práctica', '2014-06-20', '0000-00-00', '2', NULL, NULL),
(14, 2, 35, 'Pendiente', 0, 0, 0, NULL, NULL, 'PRACTICA DE SOPORTE DE BASE DE DATOS', '2014-06-26', '0000-00-00', '1', NULL, NULL),
(18, 1, 32, 'Pendiente', 0, 0, 0, NULL, NULL, 'a', '2014-07-07', '0000-00-00', '1', NULL, NULL),
(19, 1, 34, 'Pendiente', 0, 0, 0, NULL, NULL, '%', '2014-07-07', '0000-00-00', '1', NULL, NULL);
...
CREATE TABLE IF NOT EXISTS `trabaja` (
  ...
  `TRA_ESTADO` enum('ACTIVO','INACTIVO') NOT NULL,
  `TRA_VIGENCIA` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  KEY `EMP_ID` (`EMP_ID`),
  KEY `REP_ID` (`REP_ID`),
  KEY `REP_ID_2` (`REP_ID`)
